...
module.bundle.HMR_BUNDLE_ID = "df27748876f732d5";
"use strict";
...
},{}],"iOY1C":[function(require,module,exports) {
...
const letterRoll = [
    ...document.querySelectorAll(".content__title[data-splitting][data-letter-roll]")
];
const letterStretch = [
    ...document.querySelectorAll(".content__title[data-splitting][data-letter-stretch]")
];
const letterFlip = [
    ...document.querySelectorAll(".content__title[data-splitting][data-letter-flip]")
];
const compactor = [
    ...document.querySelectorAll(".content__title[data-splitting][data-compactor]")
];
const fadedSort = [
    ...document.querySelectorAll(".content__title[data-splitting][data-faded-sort]")
];
const letterRise = [
    ...document.querySelectorAll(".content__title[data-splitting][data-letter-rise]")
];
const sideRoll = [
    ...document.querySelectorAll(".content__title[data-splitting][data-side-roll]")
];
const obfText = [
    ...document.querySelectorAll(".content__title[data-splitting][data-obf-text]")
];
const fizzLetters = [
    ...document.querySelectorAll(".content__title[data-splitting][data-fizz-letters]")
];
const fadePop = [
    ...document.querySelectorAll(".content__title[data-splitting][data-fade-pop]")
];
const letterFall = [
    ...document.querySelectorAll(".content__title[data-splitting][data-letter-fall]")
];
const scatterFlip = [
    ...document.querySelectorAll(".content__title[data-splitting][data-scatter-flip]")
];
const growIn = [
    ...document.querySelectorAll(".content__title[data-splitting][data-grow-in]")
];
const fangs = [
    ...document.querySelectorAll(".content__title[data-splitting][data-fangs]")
];
const ghost = [
    ...document.querySelectorAll(".content__title[data-splitting][data-ghost]")
];
...
const loadObfText = [
    ...document.querySelectorAll("[data-splitting][data-obfLoad]")
];
const symbols = [
    "0",
    "1",
...
loadObfText.forEach((text)=>{
    const chars = text.querySelectorAll(".char");
    chars.forEach((char, position)=>{
        let initialHTML = char.innerHTML;
        if (text.classList.contains("animFast")) (0, _gsap.gsap).fromTo(char, {
            opacity: 0
        }, {
            duration: 0.01,
...
},{"lenis":"JS2ak","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"JS2ak":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
